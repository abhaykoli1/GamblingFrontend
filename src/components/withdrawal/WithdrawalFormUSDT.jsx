  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <input
        type="number"
        name="amount"
        placeholder={`Payout amount (USDT) max ${MAX_WITHDRAWAL_AMOUNT}`}
      ...
      <button
        ...
        className="w-full cursor-pointer bg-gradient-to-b shadow-xs shadow-[#9C1137] from-[#9C1137] via-[#9C1137] to-black text-white py-2 rounded disabled:cursor-not-allowed disabled:opacity-60"
      >
