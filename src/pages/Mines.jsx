...
const minePositions = [
    3, 7, 12, 17, 20, 1, 5, 9, 13, 22,
    24, 0, 2, 4, 6, 8, 10, 11, 14, 15,
    16, 18, 19, 21,
];
            ...
            <div className="bg-gray-800 px-6 py-4 flex flex-col md:flex-row gap-4 items-center w-full justify-between">
                ...
                <div className="flex items-center space-x-4">
                    <div className="flex flex-col">
                        <label className="text-xs text-gray-400 mb-1 text-start">Bet Amount</label>
                        <input
                            type="number"
                            min={10}
                            value={bet}
                    ...
                    <div className="flex flex-col">
                        <label className="text-xs text-gray-400 mb-1 text-start">Gems</label>
                        <span className="w-24 px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white text-sm focus:outline-none focus:border-blue-500 disabled:opacity-50 text-start">{25 - mineCount}</span>
                    </div>
                </div>
